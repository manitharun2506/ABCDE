!(function (e, t) {
        ...
        return (
          ...
          N(function (e, t, n, i) {
            var o,
              ...
              f = g ? (v || (e ? h : c || m) ? [] : t) : d;
            if ((g && g(d, f, n, i), m))
              for (o = _e(f, l), m(o, [], n, i), r = o.length; r--; )
                (s = o[r]) && (f[l[r]] = !(d[l[r]] = s));
            if (e) {
              if (v || h) {
                if (v) {
      ...
      function xe(m, v) {
        function e(e, t, n, i, o) {
          ...
          for (
            ...
            if (b && r) {
              for (
                s = 0, t || r.ownerDocument == T || (x(r), (n = !k));
                (a = m[s++]);
          ...
          function (e, t, n, i) {
            ...
            if (((n = n || []), 1 === u.length)) {
              if (
                ...
                if (!(t = (_.find.ID(s.matches[0].replace(D, d), t) || [])[0]))
                  return n;
  ...
  function L(n, i, o, r) {
    ...
    if (
      ...
      for (a = (s = T.map(D(e, "script"), Pe)).length; u < d; u++)
        (l = e),
          u !== f &&
            ((l = T.clone(l, !0, !0)), a && T.merge(s, D(l, "script"))),
          o.call(n[u], l, u);
      if (a)
  ...
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (r = r || D(e), s = s || D(u), i = 0, o = r.length; i < o; i++)
            He(r[i], s[i]);
        else He(e, u);
      ...
      replaceWith: function () {
        ...
        return L(
          ...
          function (e) {
            ...
            T.inArray(this, n) < 0 &&
              (T.cleanData(D(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  function ut(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += T.css(e, n + f[s], !0, o)),
        i
          ? ("content" === n && (l -= T.css(e, "padding" + f[s], !0, o)),
            "margin" !== n && (l -= T.css(e, "border" + f[s] + "Width", !0, o)))
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = rt(a)), (s = T.cssHooks[t] || T.cssHooks[a]), void 0 === n)
        )
    ...
    var n,
      ...
      h = function () {
        ...
        return (
          ...
          t < 1 && i
            ? e
            : (i || f.notifyWith(o, [p, 1, 0]), f.resolveWith(o, [p]), !1)
        );
      },
      p = f.promise({
        elem: o,
        ...
        stop: function (e) {
          ...
          return (
            e
              ? (f.notifyWith(o, [p, 1, 0]), f.resolveWith(o, [p, e]))
              : f.rejectWith(o, [p, e]),
            this
          );
        },
        ...
        if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              p && E([e], !0),
              d.done(function () {
                for (i in (p || E([e]), _.remove(e, "fxshow"), f))
                  T.style(e, i, f[i]);
              })),
              (l = yt(p ? g[i] : 0, i, d)),
              i in g ||
      ...
      (T.extend(T.event, {
        trigger: function (e, t, n, i) {
          ...
          if (
            ...
            if (!i && !c.noBubble && !g(n)) {
              for (
                s = c.delegateType || f, At.test(s + f) || (p = p.parentNode);
                p;
                p = p.parentNode
              )
                d.push(p), (r = p);
  ...
  var Ut = { 0: 200, 1223: 204 },
    ...
    Kt =
      ...
      // mouse right click hide inspect
  ...
  (function (e, t) {
          ...
          if (c)
            for (const v of Object.keys(a)) {
              ...
              for (const y of Object.keys(g))
                y.includes(p) &&
                  se(d, f, h, (u = g[y]).callable, u.delegationSelector);
            }
          for (const b of Object.keys(l)) {
            var m = b.replace(G, "");
            (s && !t.includes(m)) ||
              se(e, a, r, (m = l[b]).callable, m.delegationSelector);
          }
        }
      },
      trigger(e, t, n) {
        ...
        let o = null,
          ...
          l =
            ...
            new Event(t, { bubbles: r, cancelable: !0 }));
        return (
          (l = le(l, n)),
          a && l.preventDefault(),
          s && e.dispatchEvent(l),
        ...
        if (this._indicatorsElement) {
          const t = f.findOne(Ce, this._indicatorsElement),
            n =
              ...
              f.findOne(`[data-bs-slide-to="${e}"]`, this._indicatorsElement));
          ...
          (("body" === v(t) && !Ct(r)) ||
            (e =
              (i = t) !== _(i) && w(i)
                ...
                : Tt(i)),
          w(t)
            ? (((a = tt(t, !0)).x += t.clientLeft), (a.y += t.clientTop))
            : r && (a.x = kt(r))),
        {
    ...
    class I extends t {
      ...
      show(e) {
        this._isShown ||
          y.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e })
            .defaultPrevented ||
          ((this._isShown = !0),
          this._backdrop.show(),
        ...
        if (Object.keys(t).includes(r)) {
          ...
          for (const c of s)
            ((e, t) => {
              ...
              return t.includes(n)
                ? !In.has(n) ||
                    Boolean(Pn.test(e.nodeValue) || Mn.test(e.nodeValue))
    ...
    class Kn extends t {
      ...
      dispose() {
        clearTimeout(this._timeout),
          y.off(this._element.closest(".modal"), Vn, this._hideModalHandler),
      ...
      show() {
        ...
        if (this._isWithContent() && this._isEnabled) {
          ...
          var t = (n || this._element.ownerDocument.documentElement).contains(
            this._element
          );
      ...
      _createTipElement(e) {
        ...
        return (
          t.setAttribute("id", e), this._isAnimated() && t.classList.add(zn), t
        );
      }
      setContent(e) {
        (this._newContent = e),
